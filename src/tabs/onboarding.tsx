            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3 p-4 bg-purple-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your keys are encrypted and stored locally</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Account abstraction for gasless transactions</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg">
                <div className="text-2xl">🌐</div>
                <div>
                  <h3 className="font-semibold text-gray-800">Multi-Chain</h3>
                  <p className="text-sm text-gray-600">Support for 6+ blockchain networks</p>
                </div>
              </div>
            </div>
