        ...
        {dApps.length === 0 ? (
          ...
          <div className="space-y-4">
            <Text className="text-sm">
              Apps that have access to your wallet. You can revoke access at any time.
            </Text>

            {dApps.map((dApp) => {
              const security = securityInfo[dApp.origin]
              return (
                <Card key={dApp.origin} className="p-4">
                    ...
                    <Flex align="center" gap="3" className="flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <Flex align="center" gap="2" mb="1">
                          <Heading size="4" className="truncate">{dApp.name}</Heading>
                          {security && (
                        ...
                        <Text className="text-sm truncate">{dApp.origin}</Text>
                        ...
                        <Flex align="center" gap="4" mt="2">
                          ...
                          <Text color={'gray'} className="text-xs">
                            Last used {formatLastUsed(dApp.lastUsedAt)}
                          </Text>
                          <Text color={'gray'} className="text-xs">
                            {dApp.accounts.length} account{dApp.accounts.length !== 1 ? 's' : ''}
                          </Text>
                        </Flex>
                      </div>
                    </Flex>
