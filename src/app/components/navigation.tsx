...
export function BottomNavigation() {
  ...
  return (
    <nav className="sticky bottom-0 left-0 right-0 border-t border-gray4 dark:border-gray12 z-10 bg-grayA2 dark:bg-grayA6 backdrop-blur-xl">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex flex-col items-center justify-center px-3 py-2 rounded-lg transition-colors min-w-0 flex-1 ${
                isActive
                  ? "text-grass7"
                  : "hover:tex-grass5 hover:bg-grayA4"
              }`
            }
          >
            <Text>
